...
class CachedIntrospectionResults {
     ...
     */
    private static final String IGNORE_BEANINFO_PROPERTY_NAME = "spring.beaninfo.ignore";
     ...
     */
    private static final ConcurrentMap<Class<?>, CachedIntrospectionResults> strongClassCache =
     ...
     */
    private static final ConcurrentMap<Class<?>, CachedIntrospectionResults> softClassCache =
